# Подсчет значения F-критерия, критерия t-Стьюдента
...
work_dir = Path.cwd()
genetherapy_path = work_dir/'stat_methods'/'genetherapy.csv'
...
df = pd.read_csv(genetherapy_path)
...
data = pd.read_csv(genetherapy_path, sep=',')
